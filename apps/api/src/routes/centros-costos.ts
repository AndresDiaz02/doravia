...
router.get("/", async (req, res) => {
  try {
    ...
    console.error("Error en GET /centros-costos:", err);
...
router.post("/", async (req, res) => {
  try {
    ...
    console.error("Error en POST /centros-costos:", err);
    res.status(500).json({ error: "Error interno del servidor." });
  }
});
...
router.patch("/:id", async (req, res) => {
  try {
    ...
    console.error("Error en PATCH /centros-costos/:id:", err);
    res.status(500).json({ error: "Error interno del servidor." });
  }
});
...
router.get("/:id/reporte", async (req, res) => {
  try {
    ...
    console.error("Error en GET /centros-costos/:id/reporte:", err);
    res.status(500).json({ error: "Error interno del servidor." });
  }
});
