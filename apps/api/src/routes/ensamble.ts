...
router.get("/:productoId/componentes", async (req, res) => {
  try {
    ...
    console.error("Error en GET /:productoId/componentes:", err);
...
router.post("/:productoId/componentes", async (req, res) => {
  try {
    ...
    console.error("Error en POST /:productoId/componentes:", err);
    res.status(500).json({ error: "Error interno del servidor." });
  }
});
...
router.delete("/:productoId/componentes/:componenteId", async (req, res) => {
  try {
    ...
    console.error("Error en DELETE /:productoId/componentes/:componenteId:", err);
    res.status(500).json({ error: "Error interno del servidor." });
  }
});
...
router.patch("/:productoId/componentes/:componenteId", async (req, res) => {
  try {
    ...
    console.error("Error en PATCH /:productoId/componentes/:componenteId:", err);
    res.status(500).json({ error: "Error interno del servidor." });
  }
});
