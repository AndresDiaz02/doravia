...
function AppInner() {
  ...
  if (!user) return <Login dark={dark} onToggleTheme={toggleTheme} />;
    ...
    <div className="h-screen flex flex-col overflow-hidden bg-slate-100 dark:bg-[#080b16]">
      <nav className="relative z-30 h-16 flex-shrink-0 overflow-x-auto border-b border-slate-200/80 bg-white/95 px-3 shadow-[0_4px_20px_rgba(15,23,42,0.06)] backdrop-blur-xl sm:px-5 dark:border-slate-800 dark:bg-[#0b1020]/95 dark:shadow-black/20 flex items-center gap-1">
        ...
        <button
          ...
          className="flex flex-shrink-0 items-center gap-1.5 rounded-lg border border-slate-200 bg-slate-50 px-2 py-1.5 text-xs font-medium text-slate-600 transition-colors hover:bg-white hover:text-violet-600 dark:border-slate-700 dark:bg-slate-800/70 dark:text-slate-300 dark:hover:bg-slate-700 dark:hover:text-violet-300 mr-1"
        >
