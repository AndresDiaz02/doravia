...
const PLANES_INFO: Record<string, { nombre: string; precio: string }> = {
  ...
  semilla:     { nombre: "Semilla",     precio: "$590.000 / año" },
  raiz:        { nombre: "Raíz",        precio: "$790.000 / año" },
  brote:       { nombre: "Brote",       precio: "$1.190.000 / año" },
  cosecha:     { nombre: "Cosecha",     precio: "$1.590.000 / año" },
  punto:       { nombre: "Punto",       precio: "$360.000 / año" },
  punto_plus:  { nombre: "Punto Plus",  precio: "$630.000 / año" },
};
...
const PLANES_LISTA = [
  ...
  { slug: "semilla",    label: "Semilla — $590.000/año",         desc: "ERP completo · Inventario · 3 usuarios" },
  { slug: "raiz",       label: "Raíz — $790.000/año",            desc: "Facturación ilimitada · 5 usuarios · 3 bodegas" },
  { slug: "brote",      label: "Brote — $1.190.000/año",         desc: "Recurrentes · CRM · Reportes comparativos" },
  { slug: "cosecha",    label: "Cosecha — $1.590.000/año",       desc: "Plan completo · Centros de costos · Ilimitado" },
];
